...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('main_offer', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Offer.price'
        db.alter_column('main_offer', 'price', self.gf('django.db.models.fields.IntegerField')())
