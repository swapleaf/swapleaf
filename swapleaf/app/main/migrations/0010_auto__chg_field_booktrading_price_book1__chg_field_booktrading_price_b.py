...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('main_booktrading', 'price_book1', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=2))

        # Changing field 'BookTrading.price_book2'
        db.alter_column('main_booktrading', 'price_book2', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2))

        # Changing field 'BookSelling.price'
        db.alter_column('main_bookselling', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=2))

        # Changing field 'BookBuying.price'
        db.alter_column('main_bookbuying', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=2))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'BookBuying.price'
        db.alter_column('main_bookbuying', 'price', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        'main.booktrading': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 5, 0, 0)'}),
            'price_book1': ('django.db.models.fields.DecimalField', [], {'max_digits': '19', 'decimal_places': '2'}),
            'price_book2': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'none'", 'max_length': '10'}),
