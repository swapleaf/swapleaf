...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('main_course', 'title')

        # Deleting field 'Course.subject'
        db.delete_column('main_course', 'subject')

        # Deleting field 'Course.crn'
        db.delete_column('main_course', 'crn')
        ...
        db.alter_column('main_course', 'course_number', self.gf('django.db.models.fields.CharField')(max_length=10))
        # Adding field 'BookTradingGiving.course1'
        db.add_column('main_booktradinggiving', 'course1',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='course1', null=True, to=orm['main.Course']),
                      keep_default=False)

        # Adding field 'BookTradingGiving.course2'
        db.add_column('main_booktradinggiving', 'course2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='course2', null=True, to=orm['main.Course']),
                      keep_default=False)

        # Adding field 'BookSelling.course'
        db.add_column('main_bookselling', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Course'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Course.title'
        db.add_column('main_course', 'title',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=100),
                      keep_default=False)

        # Adding field 'Course.subject'
        db.add_column('main_course', 'subject',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=10),
                      keep_default=False)

        # Adding field 'Course.crn'
        db.add_column('main_course', 'crn',
        ...
        # Changing field 'Course.course_number'
        db.alter_column('main_course', 'course_number', self.gf('django.db.models.fields.IntegerField')())
        # Deleting field 'BookTradingGiving.course1'
        db.delete_column('main_booktradinggiving', 'course1_id')

        # Deleting field 'BookTradingGiving.course2'
        db.delete_column('main_booktradinggiving', 'course2_id')

        # Deleting field 'BookSelling.course'
        db.delete_column('main_bookselling', 'course_id')
