...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BookTradingGiving.course'
        db.add_column('main_booktradinggiving', 'course',
    ...
    def backwards(self, orm):
        ...
        db.add_column('main_booktradinggiving', 'course1',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='course1', null=True, to=orm['main.Course'], blank=True),
                      keep_default=False)

        # Adding field 'BookTradingGiving.course2'
        db.add_column('main_booktradinggiving', 'course2',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='course2', null=True, to=orm['main.Course'], blank=True),
                      keep_default=False)

        # Deleting field 'BookTradingGiving.course'
        db.delete_column('main_booktradinggiving', 'course_id')
    ...
    models = {
        ...
        'main.booktradinggiving': {
            ...
            'course': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'course1'", 'null': 'True', 'to': "orm['main.Course']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 21, 0, 0)'}),
            'send_alert': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'none'", 'max_length': '10'}),
