...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BookTradingGiving.condition'
        db.delete_column('main_booktradinggiving', 'condition')

        # Adding field 'BookTradingGiving.condition1'
        db.add_column('main_booktradinggiving', 'condition1',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=1),
                      keep_default=False)

        # Adding field 'BookTradingGiving.condition2'
        db.add_column('main_booktradinggiving', 'condition2',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BookTradingGiving.condition'
        db.add_column('main_booktradinggiving', 'condition',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=1),
                      keep_default=False)

        # Deleting field 'BookTradingGiving.condition1'
        db.delete_column('main_booktradinggiving', 'condition1')

        # Deleting field 'BookTradingGiving.condition2'
        db.delete_column('main_booktradinggiving', 'condition2')
    ...
    models = {
        ...
        'main.booktradinggiving': {
            ...
            'condition2': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
