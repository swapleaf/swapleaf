...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field counter_offer on 'BookTransaction'
        db.create_table('main_booktransaction_counter_offer', (
        ...
        db.create_unique('main_booktransaction_counter_offer', ['booktransaction_id', 'offer_id'])


    def backwards(self, orm):
        # Removing M2M table for field counter_offer on 'BookTransaction'
        db.delete_table('main_booktransaction_counter_offer')
    ...
    models = {
        ...
        'main.booktransaction': {
            ...
            'counter_offer': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'counter_offer'", 'null': 'True', 'to': "orm['main.Offer']"}),
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Course']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'offer': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'offer'", 'null': 'True', 'to': "orm['main.Offer']"}),
        ...
        'main.offer': {
            ...
            'offer_status': ('django.db.models.fields.CharField', [], {'default': "'1'", 'max_length': '1'}),
