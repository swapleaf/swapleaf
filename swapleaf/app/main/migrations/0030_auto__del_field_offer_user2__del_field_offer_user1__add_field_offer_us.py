...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Offer.user2'
        db.delete_column('main_offer', 'user2_id')

        # Deleting field 'Offer.user1'
        db.delete_column('main_offer', 'user1_id')

        # Adding field 'Offer.user_offer'
        db.add_column('main_offer', 'user_offer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='user_offer', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Offer.user_receive'
        db.add_column('main_offer', 'user_receive',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='user_receive', to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Message.user_receive'
        db.delete_column('main_message', 'user_receive_id')

        # Deleting field 'Message.user_send'
        db.delete_column('main_message', 'user_send_id')

        # Adding field 'Message.sender'
        db.add_column('main_message', 'sender',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='sender', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Message.receiver'
        db.add_column('main_message', 'receiver',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='receiver', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Offer.user2'
        db.add_column('main_offer', 'user2',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='user2', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Offer.user1'
        db.add_column('main_offer', 'user1',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='user1', to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Offer.user_offer'
        db.delete_column('main_offer', 'user_offer_id')

        # Deleting field 'Offer.user_receive'
        db.delete_column('main_offer', 'user_receive_id')

        # Adding field 'Message.user_receive'
        db.add_column('main_message', 'user_receive',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='user_receive', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Message.user_send'
        db.add_column('main_message', 'user_send',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='user_send', to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Message.sender'
        db.delete_column('main_message', 'sender_id')

        # Deleting field 'Message.receiver'
        db.delete_column('main_message', 'receiver_id')
    ...
    models = {
        ...
        'main.booktransaction': {
            ...
            'post_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 26, 0, 0)'}),
        ...
        'main.message': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 26, 0, 0)'}),
        ...
        'main.offer': {
            ...
            'offer_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 26, 0, 0)'}),
