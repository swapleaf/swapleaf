...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BookTrading.book_trader2'
        db.delete_column('main_booktrading', 'book_trader2_id')

        # Deleting field 'BookTrading.book_trader1'
        db.delete_column('main_booktrading', 'book_trader1_id')

        # Adding field 'BookTrading.book_trade1'
        db.add_column('main_booktrading', 'book_trade1',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='book_trader1', to=orm['main.Book']),
                      keep_default=False)

        # Adding field 'BookTrading.book_trade2'
        db.add_column('main_booktrading', 'book_trade2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='book_trader2', null=True, to=orm['main.Book']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BookTrading.book_trader2'
        db.add_column('main_booktrading', 'book_trader2',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='book_trader2', null=True, to=orm['main.Book'], blank=True),
                      keep_default=False)

        # Adding field 'BookTrading.book_trader1'
        db.add_column('main_booktrading', 'book_trader1',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='book_trader1', to=orm['main.Book']),
                      keep_default=False)

        # Deleting field 'BookTrading.book_trade1'
        db.delete_column('main_booktrading', 'book_trade1_id')

        # Deleting field 'BookTrading.book_trade2'
        db.delete_column('main_booktrading', 'book_trade2_id')
