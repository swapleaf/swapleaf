...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_course', 'institution',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['main.Institution']),
                      keep_default=False)

        # Adding field 'BookGiving.transaction_id'
        db.add_column('main_bookgiving', 'transaction_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0, unique=True),
                      keep_default=False)

        # Adding field 'BookTrading.transaction_id'
        db.add_column('main_booktrading', 'transaction_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0, unique=True),
                      keep_default=False)

        # Adding field 'BookSelling.transaction_id'
        db.add_column('main_bookselling', 'transaction_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0, unique=True),
                      keep_default=False)

        # Adding field 'BookBuying.transaction_id'
        db.add_column('main_bookbuying', 'transaction_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0, unique=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('main_course', 'institution_id')

        # Deleting field 'BookGiving.transaction_id'
        db.delete_column('main_bookgiving', 'transaction_id')

        # Deleting field 'BookTrading.transaction_id'
        db.delete_column('main_booktrading', 'transaction_id')

        # Deleting field 'BookSelling.transaction_id'
        db.delete_column('main_bookselling', 'transaction_id')

        # Deleting field 'BookBuying.transaction_id'
        db.delete_column('main_bookbuying', 'transaction_id')
    ...
    models = {
        ...
        'main.bookbuying': {
            ...
            'transaction_id': ('django.db.models.fields.IntegerField', [], {'unique': 'True'}),
