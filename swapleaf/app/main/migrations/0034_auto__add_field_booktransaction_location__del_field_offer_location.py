...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BookTransaction.location'
        db.add_column('main_booktransaction', 'location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'Offer.location'
        db.delete_column('main_offer', 'location')


    def backwards(self, orm):
        # Deleting field 'BookTransaction.location'
        db.delete_column('main_booktransaction', 'location')

        # Adding field 'Offer.location'
        db.add_column('main_offer', 'location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)
