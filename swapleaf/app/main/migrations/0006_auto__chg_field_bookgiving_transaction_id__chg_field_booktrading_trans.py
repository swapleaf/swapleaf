...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BookGiving.transaction_id'
        db.alter_column('main_bookgiving', 'transaction_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))

        # Changing field 'BookTrading.transaction_id'
        db.alter_column('main_booktrading', 'transaction_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))

        # Changing field 'BookSelling.transaction_id'
        db.alter_column('main_bookselling', 'transaction_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))

        # Changing field 'BookBuying.transaction_id'
        db.alter_column('main_bookbuying', 'transaction_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))

    def backwards(self, orm):

        # Changing field 'BookGiving.transaction_id'
        db.alter_column('main_bookgiving', 'transaction_id', self.gf('django.db.models.fields.IntegerField')(unique=True))

        # Changing field 'BookTrading.transaction_id'
        db.alter_column('main_booktrading', 'transaction_id', self.gf('django.db.models.fields.IntegerField')(unique=True))

        # Changing field 'BookSelling.transaction_id'
        db.alter_column('main_bookselling', 'transaction_id', self.gf('django.db.models.fields.IntegerField')(unique=True))

        # Changing field 'BookBuying.transaction_id'
        db.alter_column('main_bookbuying', 'transaction_id', self.gf('django.db.models.fields.IntegerField')(unique=True))
