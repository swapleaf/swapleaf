...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.partner_status'
        db.add_column('main_userprofile', 'partner_status',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, null=True),
                      keep_default=False)


        # Changing field 'Book.title'
        db.alter_column('main_book', 'title', self.gf('django.db.models.fields.CharField')(max_length=600))

        # Changing field 'Book.author'
        db.alter_column('main_book', 'author', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):
        # Deleting field 'UserProfile.partner_status'
        db.delete_column('main_userprofile', 'partner_status')


        # Changing field 'Book.title'
        db.alter_column('main_book', 'title', self.gf('django.db.models.fields.CharField')(max_length=300))

        # Changing field 'Book.author'
        db.alter_column('main_book', 'author', self.gf('django.db.models.fields.CharField')(max_length=150))
    ...
    models = {
        ...
        'main.bookbuying': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 20, 0, 0)'}),
        ...
        'main.notify': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 20, 0, 0)'}),
