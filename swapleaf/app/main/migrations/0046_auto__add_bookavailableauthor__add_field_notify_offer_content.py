...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notify.offer_content'
        db.add_column('main_notify', 'offer_content',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Notify.offer_content'
        db.delete_column('main_notify', 'offer_content')
    ...
    models = {
        ...
        'main.booktransaction': {
            ...
            'post_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 3, 0, 0)'}),
        ...
        'main.message': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 3, 0, 0)'}),
        ...
        'main.offer': {
            ...
            'offer_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 3, 0, 0)'}),
