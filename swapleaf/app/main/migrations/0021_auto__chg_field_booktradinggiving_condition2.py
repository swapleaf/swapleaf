...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BookTradingGiving.condition2'
        db.alter_column('main_booktradinggiving', 'condition2', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

    def backwards(self, orm):

        # Changing field 'BookTradingGiving.condition2'
        db.alter_column('main_booktradinggiving', 'condition2', self.gf('django.db.models.fields.CharField')(default=0, max_length=1))
