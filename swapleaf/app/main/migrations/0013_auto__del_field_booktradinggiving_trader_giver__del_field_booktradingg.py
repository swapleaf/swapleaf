...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BookTradingGiving.trader_giver'
        db.delete_column('main_booktradinggiving', 'trader_giver_id')

        # Deleting field 'BookTradingGiving.receiver'
        db.delete_column('main_booktradinggiving', 'receiver_id')

        # Deleting field 'BookTradingGiving.book'
        db.delete_column('main_booktradinggiving', 'book_id')

        # Adding field 'BookTradingGiving.trader1_giver'
        db.add_column('main_booktradinggiving', 'trader1_giver',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='giver', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'BookTradingGiving.trader2_receiver'
        db.add_column('main_booktradinggiving', 'trader2_receiver',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='receiver', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'BookTradingGiving.book1'
        db.add_column('main_booktradinggiving', 'book1',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='book1', to=orm['main.Book']),
                      keep_default=False)

        # Adding field 'BookTradingGiving.book2'
        db.add_column('main_booktradinggiving', 'book2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='book2', null=True, to=orm['main.Book']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BookTradingGiving.trader_giver'
        db.add_column('main_booktradinggiving', 'trader_giver',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='giver', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'BookTradingGiving.receiver'
        db.add_column('main_booktradinggiving', 'receiver',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='receiver', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Adding field 'BookTradingGiving.book'
        db.add_column('main_booktradinggiving', 'book',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['main.Book']),
                      keep_default=False)

        # Deleting field 'BookTradingGiving.trader1_giver'
        db.delete_column('main_booktradinggiving', 'trader1_giver_id')

        # Deleting field 'BookTradingGiving.trader2_receiver'
        db.delete_column('main_booktradinggiving', 'trader2_receiver_id')

        # Deleting field 'BookTradingGiving.book1'
        db.delete_column('main_booktradinggiving', 'book1_id')

        # Deleting field 'BookTradingGiving.book2'
        db.delete_column('main_booktradinggiving', 'book2_id')
