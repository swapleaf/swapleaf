...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_userprofile', 'school',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['main.Institution']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.school'
        db.delete_column('main_userprofile', 'school_id')
    ...
    models = {
        ...
        'main.userprofile': {
            ...
            'school': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Institution']"}),
