...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BookTransaction.send_alert'
        db.delete_column('main_booktransaction', 'send_alert')

        # Adding field 'BookTransaction.alert_email'
        db.add_column('main_booktransaction', 'alert_email',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BookTransaction.send_alert'
        db.add_column('main_booktransaction', 'send_alert',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'BookTransaction.alert_email'
        db.delete_column('main_booktransaction', 'alert_email')
