...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Book.isbn10'
        db.alter_column('main_book', 'isbn10', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Book.isbn13'
        db.alter_column('main_book', 'isbn13', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Book.isbn10'
        db.alter_column('main_book', 'isbn10', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Book.isbn13'
        db.alter_column('main_book', 'isbn13', self.gf('django.db.models.fields.IntegerField')(null=True))
