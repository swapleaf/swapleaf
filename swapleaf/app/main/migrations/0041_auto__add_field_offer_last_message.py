...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offer.last_message'
        db.add_column('main_offer', 'last_message',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='last_message', null=True, to=orm['main.Message']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offer.last_message'
        db.delete_column('main_offer', 'last_message_id')
