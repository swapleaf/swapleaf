...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BookGiving.condition'
        db.add_column('main_bookgiving', 'condition',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=1),
                      keep_default=False)

        # Adding field 'BookGiving.status'
        db.add_column('main_bookgiving', 'status',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=10),
                      keep_default=False)

        # Adding field 'BookTrading.book_condition1'
        db.add_column('main_booktrading', 'book_condition1',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=1),
                      keep_default=False)

        # Adding field 'BookTrading.book_condition2'
        db.add_column('main_booktrading', 'book_condition2',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=1),
                      keep_default=False)

        # Adding field 'BookTrading.status'
        db.add_column('main_booktrading', 'status',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BookGiving.condition'
        db.delete_column('main_bookgiving', 'condition')

        # Deleting field 'BookGiving.status'
        db.delete_column('main_bookgiving', 'status')

        # Deleting field 'BookTrading.book_condition1'
        db.delete_column('main_booktrading', 'book_condition1')

        # Deleting field 'BookTrading.book_condition2'
        db.delete_column('main_booktrading', 'book_condition2')

        # Deleting field 'BookTrading.status'
        db.delete_column('main_booktrading', 'status')
