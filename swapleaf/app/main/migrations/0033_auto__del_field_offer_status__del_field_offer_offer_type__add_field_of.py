...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('main_offer', 'status')

        # Deleting field 'Offer.offer_type'
        db.delete_column('main_offer', 'offer_type')

        # Adding field 'Offer.view_status'
        db.add_column('main_offer', 'view_status',
                      self.gf('django.db.models.fields.CharField')(default='new', max_length=3),
                      keep_default=False)

        # Adding field 'Offer.offer_status'
        db.add_column('main_offer', 'offer_status',
    ...
    def backwards(self, orm):
        ...
        db.add_column('main_offer', 'status',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=1),
                      keep_default=False)

        # Adding field 'Offer.offer_type'
        db.add_column('main_offer', 'offer_type',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=1),
                      keep_default=False)

        # Deleting field 'Offer.view_status'
        db.delete_column('main_offer', 'view_status')

        # Deleting field 'Offer.offer_status'
        db.delete_column('main_offer', 'offer_status')
