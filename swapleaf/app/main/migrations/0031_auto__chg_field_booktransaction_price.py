...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BookTransaction.price'
        db.alter_column('main_booktransaction', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'BookTransaction.price'
        db.alter_column('main_booktransaction', 'price', self.gf('django.db.models.fields.IntegerField')())
