...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_notify', (
            ...
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 12, 17, 0, 0))),
            ('elapse_time', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('main', ['Notify'])

        # Adding field 'BookBuying.condition'
        db.add_column('main_bookbuying', 'condition',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BookBuying.condition'
        db.delete_column('main_bookbuying', 'condition')
